...
3. Supabase SQL Editor에서 `0015_assistant.sql`과 `0016_assistant_attachments.sql` 실행. 0015는 anon의 games 조회를 열 단위로 제한한다 — 접수 폼은 id/name/logo_path만 읽는다
